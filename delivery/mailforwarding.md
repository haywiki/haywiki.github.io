...
При оформлении заказа на Amazon, [woot.com](http://woot.com/), сайтах Nike, и так далее, нужно указать
...
[приложить invoice для таможни](/delivery/globbing-customs.md), что важно (об этом ниже в секции про различия). Сделать это можно
...
[At customs (на таможне)](/delivery/globbing-customs.md).

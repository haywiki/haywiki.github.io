...
## Не заказывайте легкую электронику из России через Globbing

Globbing очень интересным образом трактует ограничение на вывоз электроники из России, запрещая авиа-доставку и отправляя по земле со сроком доставки в месяц.

**Практически любую электронику на самом деле МОЖНО заказывать из РФ!** Актуальные запреты на вывоз можно узнать на
этом сайте (https://www.alta.ru/news/88065/), запреты для ЕАЭС регулирует постановление №312. Многие товары были исключены
из запрета еще в мае 2022 года, но службы доставки все равно отказываются принимать товары к перевозке.
Мы рекомендуем отправлять такие посылки с помощью Onex или частных перевозчиков.

Перед заказом мы все-таки рекомендуем уточнить возможность доставки через техподдержку [@OnexAmPrimeChat](https://t.me/OnexAmPrimeChat).

...
**⚠️ Из гайда и из рекомендаций сообщества удалён перевозчик Никита Почукалин.**

Поводом стал неприятный инцидент, [описанный в чате](https://t.me/am_delivery), но негативные отзывы о нём копились
уже некоторое время. Что известно по фактам:

- посылки отправляются не из Москвы, а из аэропорта Нижнего Новгорода — возможно, раньше это было не так;
- за состоянием груза не следят: вещи одного из клиентов оставили в сырости, и за время перевозки они успели заплесневеть;
- **к грузу без согласования подложили чужие таблетки, из-за которых возникли вопросы на таможне.** Это прямой риск
  для получателя: отвечать за содержимое посылки перед таможней придётся именно ему.

Ссылку на его контакт в телеграме мы намеренно не оставляем: это было бы рекламой. Мы не хотим, чтобы люди продолжали
ему писать и чтобы его контакт индексировался поисковиками.

---
title: Эмиграция и жизнь с питомцем в Армении
layout: page
---
...
Для поездки с питомцем в Грузию вам потребуется:

- Ветеринарный паспорт с чипом, прививками, так же как и для поездки в Армению.
- Справка об осмотре из ветеринарной клиники или [Звартноц Карго](https://yandex.ru/maps/org/zvartnots_cargo_terminal/158938732784/).

...
идентифицировано при введении вакцины. Поэтому СНАЧАЛА ставим чип, потом делаем все вакцины.
**Чипирование и вакцинацию можно провести в один день**, если чип установлен до введения вакцины.
Ждать следующего дня не нужно.
...
Официально возвращение по тому же сертификату ТС не прописано. Нам известны случаи, когда по нему удавалось
вернуться в течение 90 дней после выезда, но это **на свой страх и риск**: гарантии, что сертификат примут, нет.
Если планируете возвращаться, лучше заранее попросить вписать в сертификат и обратный маршрут.

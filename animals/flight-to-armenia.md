...
**Для поездки из России в Армению титры не нужны!** Для дальнейшей поездки требования зависят от страны
и вида животного: например, для въезда в ЕС из Армении титры нужны, а правила США различаются для собак и кошек.
[Подробности по странам и срокам](rabies-titers.md).

[Грузия: официальные исключения и практика проверок](georgia-titers.md).
...
- **СББЖ говорит, что для перелета в Армению достаточно ветпаспорта без сертификата ТС. Что делать?**
  Разные аэропорты трактуют требования по-разному. Есть успешные истории перелета из Сочи по одному ветпаспорту
  с прививками и печатью об осмотре. Если вы летите из Сочи, Минеральных Вод, Краснодара, Новосибирска или Казани,
  лучше заранее уточнить в ветеринарном контроле аэропорта вылета, достаточно ли такого паспорта или нужен
  сертификат ТС и печать перед вылетом.
  После поездки расскажите в [нашем чате](https://t.me/am_pets), как всё прошло: укажите дату, аэропорт,
  авиакомпанию и какие документы у вас попросили.
...
Не доставайте своего питомца из переноски до выхода из аэропорта. Таможню проходить не нужно, таможенную декларацию
тоже подавать не нужно, если вы летите из России. Так что проходите паспортный контроль, получаете багаж и смело идете
в город через зеленый коридор.

## Истории успеха!

- [Истории переезда](flight-stories.md) — здесь мы собираем истории реальных переезжающих людей, там можно узнать

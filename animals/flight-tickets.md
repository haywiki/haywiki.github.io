...
Utair, Azimut, S7, Победа, FlyOne Armenia, Cyprus Airways). При покупке будет опция «оплатить провоз животного».
Если звериный билет оплачен, это значит, что животное зарегистрировано на рейс, больше ничего делать не надо.
Если на сайте купить звериный билет нельзя, то или авиакомпания
...
Armenian Airlines разрешает сначала купить билет на человека, затем прислать им на почту данные своего бронирования +
...
- **Armenian Airlines** - писать в вайбер по номеру +37441117770;

...
Обновление от 29.04.2026: Для поездок из Армении в Грузию нужны [титры антител к бешенству](rabies-titers.md). Титры проверяют
не всегда, но известно множество случаев разворота как на автомобильной, так и на ж/д границе при их отсутствии.

На 29.04.26 при пересечении границы РФ - Грузия титры не проверяют. При поездке **из Армении в Грузию** титры проверяют,

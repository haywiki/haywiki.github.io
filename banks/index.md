...
Ряд банков имеют ограничения на использование своих онлайн сервисов из ряда стран, например из России или Турции, иногда это бывает явно - приложение отказывается открываться, не отображается окно для ввода 3DS кода, но иногда бывает сложно понять - всё выглядит нормально, но в приложении не отображается информация о счетах, или после ввода 3DS кода транзакция отклоняется, техническая поддержка банков как правило не может помочь в таких ситуациях, но всегда помогает использование VPN с Армянским, Европейским или США сервером.

...
6. Операция происходит из "нежелательной" страны. Ряд банков имеют ограничения на использование онлайн сервисов из определенных локаций, например из России, Турции, некоторых стран Латинской Америки. В таких случаях не отображается окно для ввода 3DS кода, либо после ввода транзакция отклоняется, могут быть другие сложности. При наличии проблем, рекомендуем использовать VPN, не обязательно с IP Армении, по опыту всё отлично работает через VPN в странах ЕС или США
...
Ряд банков имеют ограничения на использование своих онлайн сервисов из ряда стран, например из России или Турции. Ограничения могут быть явными - приложение отказывается открываться, не отображается окно для ввода 3DS кода, но иногда бывает сложно понять, что ограничение есть - всё выглядит нормально, но в приложении не отображается информация о счетах, или после ввода 3DS кода транзакция отклоняется, техническая поддержка банков как правило не может помочь в таких ситуациях. Для обхода подобных ограничений рекомендуем использовать VPN с Армянским, Европейским или США сервером.

...
- В Араратбанке при наличии загранпаспорта, [нотариально заверенного перевода главной страницы паспорта](../documents/passport-translation.md) (имени) на армянский, и [соцномера](../documents/social-number.md).

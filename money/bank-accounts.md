...
Таким образом, карта ArCa-МИР скорее является дополнительной опцией для случаев посещения РФ, но вряд ли её можно рекомендовать как одну из основных карт. Она также может быть полезна как просто [способ перевода денег из РА в РФ](https://docs.google.com/document/d/10ChXMUn6TXN9WgtExoJJAofohxV0BBM9iuhe1IX-zGk/edit#heading=h.k4kt1m15jie2).

### Почему операции по карте не отображаются в истории сразу?

Во всех банках РА операции попадают в историю операций по карте после клиринга (проведения), что может занять 1-2 рабочих дня.

В связи с этим, приложения банков РА, как правило, показывают два баланса: доступный (за вычетом не проведенных операций) и текущий (отражающий состояние с учетом только проведенных операций).
...
Приложение ArCa также позволяет [переводить деньги между счетами и картами банков РА](bank-transfer-am.md) с комиссией банка-отправителя. В нем также можно смотреть баланс карт всех банков, входящих в сеть ArCa, и делать ряд других вещей. Например, можно оплачивать коммунальные платежи не по одному, а все сразу (группой), настроить периодические переводы между картами, и так далее.

## Другие вопросы о банках Армении

- [Способы перевода денег из банков РФ в банки Армении](bank-transfer-ru-am.md)
- [Способы перевода денег между банками Армении](bank-transfer-am.md)

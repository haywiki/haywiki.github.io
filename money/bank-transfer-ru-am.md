...
При переводе сумм больше эквивалента USD 10000 стоит заранее подготовить [документы о происхождении денег](https://docs.google.com/document/d/10ChXMUn6TXN9WgtExoJJAofohxV0BBM9iuhe1IX-zGk/edit#heading=h.7ml9i3ewr0z3).
...
Перед совершением любых переводов **обязательно** **ознакомьтесь** с [вопросом 14](https://docs.google.com/document/d/10ChXMUn6TXN9WgtExoJJAofohxV0BBM9iuhe1IX-zGk/edit#heading=h.7ml9i3ewr0z3) и секциями про комиссии и **проблемные банки** ниже в этом вопросе.
...
Если у вас нет опыта осуществления SWIFT или межбанковских переводов, получите в банке-получателе реквизиты для переводов, [посмотрите на примеры в вопросе 6](https://docs.google.com/document/d/10ChXMUn6TXN9WgtExoJJAofohxV0BBM9iuhe1IX-zGk/edit#heading=h.1xtoylfdv2sg), и если вопросы остались, обратитесь в поддержку банка-отправителя за помощью.
...
В июне 2022 Юнибанк [сменил банк-партнер для SWIFT переводов из РФ](https://t.me/am_banking_and_residency/12). Новый партнер, Unistream Bank, [не работает с JPMorgan](https://t.me/am_banking_and_residency/26), банком-партнером для SWIFT переводов большого числа банков. Это значит, что **перевод из Росбанка, банка Интеза, банка Ренессанс Кредит, Акбарс Банка, БКС, Банка Санкт-Петербург, Авангарда, Юникредита, Уралсиба, МТС Банка гарантированно не дойдёт в Юнибанк.**
...
Bank of Georgia используется как один из вариантов intermediary несколькими банками в РА.
...
2. Откройте USD (EUR, GBP, CHF, …) счет в банке-получателе в РА.
3. Получите в банке-получателе **актуальные реквизиты для SWIFT переводов** в нужной валюте. Реквизиты могут меняться. Если полученные данные не совпадают с [таблицей сообщества](https://docs.google.com/spreadsheets/d/1NjVtdC2WSna3q47Hnb6_QdN0Vx1ePFgvo5fn5M18q84/edit#gid=0), [сообщите нам об этом](https://t.me/am_banking_and_relocation_chat).
...
Постоянно проживающим в РА очень рекомендуется **связаться с банком и подтвердить проживание по адресу стране**, попросив [обновить адрес в клиентских данных](../documents/proof-of-residence.md#bank-address).

## Перевод рублей из банка в РФ на счет в Армении {#spfs}

Перед совершением любых переводов обязательно ознакомьтесь с [вопросом 14](https://docs.google.com/document/d/10ChXMUn6TXN9WgtExoJJAofohxV0BBM9iuhe1IX-zGk/edit#heading=h.7ml9i3ewr0z3).

С рублевого счета в банке РФ можно перевести деньги на рублевый счет в банк РА. Перевод осуществляется по банковским реквизитам подобно межбанковскому переводу внутри РФ, и проводится через [инфраструктуру СПФС](https://www.cbr.ru/PSystem/fin_msg_transfer_system/).
...
1. Откройте рублевый счет в банке-получателе в РА. Выпускать к нему карту не нужно, счет будет использоваться лишь для переводов с последующей покупкой нужных вам валют (AMD, USD, EUR, GBP, …)
...
Эти фразы призваны охладить стремление к массовому транзиту из РФ или в РФ через банки Армении. Подобный массовый транзит подставляет банки РА под риск вторичных санкций и сильно повышает риски нарушения антиотмывочного законодательства.
...
### Процесс прохождения проверки глазами клиента
...
Банки рекомендуют заранее предоставлять документы и предупреждать о крупных (начиная с десятков тысяч USD) переводах. Это позволит ускорить процесс одобрения.
...
- У меня в Армении есть друг/подруга/коллега, могу ли я ему/ей переслать им USD или EUR из РФ на хранение? Это законно? К подруге придёт налоговая РА?
...
1. Определение ограничений на такой перевод со стороны [валютного законодательства РФ](../laws/restrictions.md)
2. [SWIFT](#swift) или [СПФС](#spfs) или [Юнистрим](unistream.md) перевод из РФ в РА
3. Подтверждение происхождения денег ([вопрос 14](https://docs.google.com/document/d/10ChXMUn6TXN9WgtExoJJAofohxV0BBM9iuhe1IX-zGk/edit#heading=h.7ml9i3ewr0z3), может потребоваться как при отправлении, так и при получении)
...
Как у отправляющей, так и у получающей стороны могут запросить подтверждение происхождения денег. [Вопрос 14](https://docs.google.com/document/d/10ChXMUn6TXN9WgtExoJJAofohxV0BBM9iuhe1IX-zGk/edit#heading=h.7ml9i3ewr0z3) описывает процесс и какие документы обычно предоставляются. Если подтверждение не предоставить, перевод или не будет отправлен, или принимающий банк откажется его принимать и возвратит отправителю.
...
При вывозе наличных из страны стоит помнить, что ЦБ РА разрешает вывоз сумм не больше эквивалента USD 10K, а вывоз AMD из страны запрещен.

...
- **[Копия нотариально заверенного перевода загранпаспорта](passport-translation)** (основной страницы с номером и именем)
...
просит у свежих иммигрантов [регистрацию в стране]() вместо просто адреса пребывания, иначе не заводит SSN и
...
- [Список миграционных отделений](ovirs).
...
- **Записать сам номер в легко копируемом виде**. Номер потребуется предоставить работодателю в РА, бухгалтеру ИП
  или ООО, в форме подачи [на вид на жительство через трудовую деятельность]() 
  (РВП), и так далее. Во избежание ошибок, проще скопировать однажды записанный номер, чем каждый раз набирать
...
[перевод паспорта](passport-translation) и без очередей за 15000 драмов. Срок изготовления — один день. Потребуется

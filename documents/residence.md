...
2. В списке доступных услуг выберите "[Подача документов на статус проживания](https://migration.e-gov.am/ru/service/residency_application/info)", затем нажмите "Записаться на прием".

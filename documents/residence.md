...
Имя и фамилию можно заполнить латиницей, но мы рекомендуем заполнить на армянском языке как в [переводе паспорта](passport-translation.md), далее вы поймете почему.
...
- **Անուն** — имя (латиницей или на армянском, как при регистрации)
- **Հայրանուն** — отчество (если имя было указано латиницей, укажите его латиницей)
- **Ազգանուն** — фамилия (латиницей или на армянском, как при регистрации)
...
**Обратите внимание!** На этом шаге Фамилию, Имя и Отчество требуется заполнить **НА АРМЯНСКОМ** языке, как в [переводе паспорта](passport-translation.md).
...
Подтвердить выбранную дату и время нужно, нажав кнопку **Հանձնել** (Отправить).

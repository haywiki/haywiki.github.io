...
- Легальная работа по трудовому договору в РА<br> (кроме граждан ЕАЭС, которые должны получать [справку о законности проживания](eaeu-cert.md))
...
В здании поднимитесь на **второй этаж** (на первом очереди из тех, кто получает гражданство РА). До введения предварительной
...
С декабря 2022 для получения карты резидента нужно взять талон в электронную очередь на втором этаже. Просто пойти в кабинет 212 без очереди больше нельзя.

## Необходимость регистрации при наличии ВНЖ

Согласно законодательству РА, получатель ВНЖ [обязан зарегистрироваться по адресу проживания](registration.md) и
поставить на документ о наличии ВНЖ штамп о регистрации. По закону на это даётся 30 дней.
...
## Нужно ли уведомлять МВД РФ о полученном ВНЖ в РА?
...
Это в полной мере относится и к карте резидента Армении. В нашем сообществе есть успешные примеры оповещения. Нужно только иметь ввиду, что форма уведомления меняется каждый год и лучше получить форму заранее лично в МВД (возможно, попросив другого человека в РФ).

**Если планов возвращаться в РФ нет**, то об уведомлении можно забыть.

## Окончание срока действия карты резидента

У карты резидента есть срок действия (один год или пять лет). Однако еще до окончания действия карты может исчезнуть условие выдачи ВНЖ: например, ИП можно закрыть.

Практических примеров, которые пояснили бы, что происходит с валидностью карты резидента в этом случае, пока очень мало. Наше понимание и аналогичные программы ВНЖ в других странах можно резюмировать так:

- В случае закрытия ИП, годовая (временная) карта резидента (ВНЖ), выданная на основании работы через ИП, **прекращает быть действительной**
- В случае закрытия ИП, пятилетняя (постоянная) карта резидента (ВНЖ), выданная на основании работы через ИП, **продолжает действовать** до истечения пятилетнего срока
